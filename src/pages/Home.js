    ...
    <div className="home-container">
      ...
      <div className="left-section">
        ...
        <div className="buttons">
         <a href="https://drive.google.com/drive/folders/1-VrvmM3SzjPcv77Tthm1HygTg6oGo4vC" target="_blank"   rel="noopener noreferrer"> <button className="portfolio-btn">Download Resume</button></a>
         <Link to="/contact">
